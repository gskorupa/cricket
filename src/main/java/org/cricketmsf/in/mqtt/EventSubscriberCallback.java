 ...
 */
public class EventSubscriberCallback implements MqttCallback {
    
    private static final Logger logger = LoggerFactory.getLogger(EventSubscriberCallback.class);
    private String rootTopic;
    private String typeSuffix;
    private int prefixLength = 0;

    public EventSubscriberCallback(String rootTopic, String typeSuffix) {
