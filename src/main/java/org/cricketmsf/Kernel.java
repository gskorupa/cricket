...
public abstract class Kernel {
    ...
    private void getEventHooks() {
        ...
        for (Method m : this.getClass().getMethods()) {
            ...
            for (EventHook hook : portArray) {
                ...
                addHookMethodNameForPort(getProceduresDictionary().getName(procedure) + "@" + eventClass, m.getName());
    ...
    private String getHookMethodNameForPort(String className, int procedure) {
        ...
        if (null == result) {
            result = portEventHookMethods.get(getProceduresDictionary().getName(Procedures.DEFAULT).concat("@").concat(className));
        }
        return result;
    }
