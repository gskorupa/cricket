...
public abstract class Kernel {
    ...
    private String getHookMethodNameForPort(String className, int procedure) {
        return portEventHookMethods.get((Procedures.ANY == procedure ? getProceduresDictionary().getName(Procedures.ANY) : getProceduresDictionary().getName(procedure)) + "@" + className);
    }
