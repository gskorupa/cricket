...
COPY dist/cricket-1.4.2.jar /cricket
...
CMD ["java", "--illegal-access=deny", "--add-modules", "java.xml.bind", "--add-modules", "java.activation", "-jar", "cricket-1.4.2.jar", "-r", "-c", "/cricket/config/cricket.json", "-s", "Microsite"]