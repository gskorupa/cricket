...
COPY dist/cricket-1.2.42.jar /cricket
...
#CMD ["java", "-jar", "./cricket-1.2.42.jar", "-r", "-c", "work/config/cricket.json"]
#CMD ["java", "-jar", "./cricket-1.2.42.jar", "-r"]
CMD ["java", "--illegal-access=deny", "--add-modules", "java.xml.bind", "--add-modules", "java.activation", "-jar", "cricket-1.2.42.jar", "-r", "-c", "/cricket/work/config/cricket.json", "-s", "Microsite"]