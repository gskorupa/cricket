...
COPY dist/cricket-1.3.0-alpha.10.jar /cricket
...
CMD ["java", "--illegal-access=deny", "--add-modules", "java.xml.bind", "--add-modules", "java.activation", "-jar", "cricket-1.3.0-alpha.10.jar", "-r", "-c", "/cricket/work/config/cricket.json", "-s", "Microsite"]